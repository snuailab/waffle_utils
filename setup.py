# Waffle Utils 🥛 (based on Ultralytics YOLO 🚀, GPL-3.0 license)
...
def get_version():
    file = PARENT / "waffle_utils/__init__.py"
    return re.search(
        r'^__version__ = [\'"]([^\'"]*)[\'"]',
...
setup(
    name="waffle_utils",  # name of pypi package
    ...
    url="https://github.com/snuailab/waffle_utils",
    project_urls={
